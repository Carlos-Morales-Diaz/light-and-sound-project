...
//  delay(1000); //1 sec
  ...
  if(String(rightNow.hour()) == "19" && String(rightNow.minute()) == "00" && String(rightNow.second()) == "00"){
    lcd.nobacklight();
  }
  if(String(rightNow.hour()) == "07" && String(rightNow.minute()) == "00" && String(rightNow.second()) == "00"){
    lcd.backlight();
  }
